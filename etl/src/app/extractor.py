...
class Extractor:
    ...
    async def extract_records(self, newer_than: dt.datetime, batch_size: int) -> AsyncGenerator[PersonRecord, None]:
        ...
        async for records in self._extract_records_by_related_film_works(modified_film_works, batch_size):
            yield records
    ...
    async def _extract_records_by_related_film_works(
        ...
        async with self._connection.transaction():
            ...
            while records := await result.fetch(batch_size):
                yield records
